  ...
  return (
    <div >
      ...
      <Routes>
        ...
        {login.user_status==="admin"?<Route path="/attendence/" element={< List setPop={setPop} login={login}/>}/>:login.user_status==="room"?<Route path="/attendence/" element={< Attendence setPop={setPop} login={login}/>}/>:<Route path="/attendence/" element={<Access data="Login Required"/>}/>}
